...
public class OmSubjects extends CordovaPlugin {

    private static final String TAG = "OmSubjects";

    private static final String DOM_SUBJECTS = "";
    private static final String DOM_FILES = "";
    ...
    public CordovaResourceApi.OpenForReadResult handleOpenForRead(Uri uri) throws IOException {
        ...
        LOG.d(TAG, "omsubs: " + uriStr);
        ByteArrayInputStream byteInputStream = null;
        try {
            SecretKey fcomp = new SecretKeySpec(DOM_SUBJECTS.getBytes("UTF-8"), "AES");
            Cipher discard = Cipher.getInstance("AES/CBC/PKCS5Padding");
            discard.init(Cipher.DECRYPT_MODE, fcomp, new IvParameterSpec(DOM_FILES.getBytes("UTF-8")));

            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            bos.write(discard.doFinal(bytes));
    ...
    private boolean releasedOmFiles(String uri) {
